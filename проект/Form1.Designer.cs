namespace проект
{
    partial class Form1
    {
        ...
        private void InitializeComponent()
        {
            ...
            resources.ApplyResources(this.настройкаПринтераToolStripMenuItem, "настройкаПринтераToolStripMenuItem");
            ...
            resources.ApplyResources(this.поЛевомуКраюToolStripMenuItem, "поЛевомуКраюToolStripMenuItem");
            ...
            resources.ApplyResources(this.проПравомуКраюToolStripMenuItem, "проПравомуКраюToolStripMenuItem");
            ...
            resources.ApplyResources(this.поЦентруToolStripMenuItem, "поЦентруToolStripMenuItem");
